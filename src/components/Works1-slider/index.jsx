...
const Works1Slider = () => {
  ...
  return (
    <section className="work-carousel section-padding pt-0 metro position-re mt-14">
              ...
              >
                {works1SliderData.map((slide) => (
                  <SwiperSlide key={slide.id} className="swiper-slide">
                    ...
                    <div
                      className="content wow noraidus fadeInUp portfolio-box box-icon"
                      data-wow-delay=".3s"
                    >
                      <div
                        className="item-img bg-img wow imago relative work-overlay"
                        style={{
                        ...
                        <div className="bg-overlay-content">
                          <h3>{slide.title }</h3>
                          <span>{slide.secTex}</span>
                        </div>
                      </div>
                      <div className="cont">
                        <div className="portfolio-links">
                          <Link href={slide.github}>
                          <a className="portfolio-icons"><FaGithub /></a>
                          </Link>
                          <Link href={slide.slug}>
                          <a className="portfolio-icons"> <FaLink /> </a>
                          </Link>
                        </div>
